...
(defn add-identity-to-table [main-frame identity]
  (controller-utils/add-record-to-table (find-identity-table main-frame) (identity-model/get-record (:id identity))))

(defn update-identity-id-table [main-frame identity]
  (controller-utils/update-record-in-table (find-identity-table main-frame) (identity-model/get-record (:id identity))))
